package cn.dbsec.core.shiro.token.manager;
...
import cn.dbsec.core.shiro.token.SampleRealm;
import cn.dbsec.core.shiro.token.ShiroToken;
import cn.dbsec.user.manager.UserManager;
...
public class TokenManager {
	...
	public static UUser login(UUser user, Boolean rememberMe) {
		...
		ShiroToken token = new ShiroToken(user.getEmail(), pswd);
		user.setPswd(pswd);
