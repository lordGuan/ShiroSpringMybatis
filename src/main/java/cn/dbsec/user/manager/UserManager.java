...
import cn.dbsec.common.utils.MathUtil;
...
public class UserManager {
	...
	public static void main(String[] args) {
		System.out.println(md5Pswd("admin", "1"));
		System.out.println(md5Pswd("role", "1"));
		System.out.println(md5Pswd("users", "1"));
	}
}
